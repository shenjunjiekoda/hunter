...
//===------------------------------------------------------------------===//
//
//  This file defines the hunter context by the hunter library and
//  command-line tools.
//
//===------------------------------------------------------------------===//
...
class HunterContext {
  private:
    ...
    std::unique_ptr< HunterOptionsProvider > m_opts_provider;

    /// \brief The current file context.
    std::string m_current_file;
    HunterOptions m_current_options;
  ...
  public:
    ...
    [[nodiscard]] const HunterOptions& get_current_options() const {
    ...
    [[nodiscard]] HunterOptions get_options_for(llvm::StringRef file) const;
